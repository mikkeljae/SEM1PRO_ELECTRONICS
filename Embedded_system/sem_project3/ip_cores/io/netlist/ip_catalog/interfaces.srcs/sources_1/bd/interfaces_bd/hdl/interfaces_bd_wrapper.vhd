...
--Date        : Mon May 16 16:28:55 2016
--Host        : mikkel running 64-bit Ubuntu 15.10
--Command     : generate_target interfaces_bd_wrapper.bd
--Design      : interfaces_bd_wrapper
...
entity interfaces_bd_wrapper is
  port (
...
end interfaces_bd_wrapper;

architecture STRUCTURE of interfaces_bd_wrapper is
  component interfaces_bd is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component interfaces_bd;
begin
interfaces_bd_i: component interfaces_bd
     port map (
