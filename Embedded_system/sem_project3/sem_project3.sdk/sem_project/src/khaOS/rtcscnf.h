...
#define TASK1         		controller_task
#define TASK2         		interface_task
#define TASK3         		uart_rx_task
...
#define INIT_TASK1      	init_controller_task
#define INIT_TASK2      	init_interface_task
#define INIT_TASK3      	init_uart_rx_task
...
#define PWM_TASK			0
#define CONTROLLER_TASK		1
#define INTERFACE_TASK		2
